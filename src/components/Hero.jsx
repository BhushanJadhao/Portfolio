        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <p className="text-white my-2 max-w-xl py-6 font-light tracking-tighter">
              ...
              dynamic web applications using the MERN stack. My experience
              includes a transformative internship at Elite Software, where I
              tackled backend challenges and optimized server performance.
              Driven by a love for seamless user experiences and problem-solving, I
              continuously push the boundaries of innovation and excellence in
              web development.
            </p>
          </div>
        </div>
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            <img
              src={profilePic}
              alt="BhushanImage"
              className="max-w-full h-auto lg:max-w-md rounded-lg"
            />
          </div>
        </div>
      </div>
